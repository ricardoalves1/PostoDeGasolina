...
import com.postoGasolina.controller.TelaCompraController.RecebePedidoCompra;
...
public class TelaCadastrarDesconto2 implements Initializable {
	...
	private void carregarEventos() {
		// TODO Auto-generated method stub
		campoSubTotal.setNumber(TelaCompraController.RecebePedidoCompra.getTotal_pagar());
			...
			public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
				...
				try{
					if (!newValue.replaceAll("[% ]", "").isEmpty()) {
						...
						final NumeroTextField qtdAtualizado = new NumeroTextField(new BigDecimal(newValue.replaceAll("[% ]", "").replaceAll("[,.]","")),
								NumberFormat.getPercentInstance());
			...
			public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
				...
				try {
					if (!newValue.replaceAll("[R$ ]", "").isEmpty()) {
						final NumeroTextField qtdAtualizado = new NumeroTextField(new BigDecimal(newValue.replaceAll("[R$ ]", "")));
